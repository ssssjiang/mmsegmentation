...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='img/train/mapillaryvistas/',
        ann_dir='ann/train/mapillaryvistas/',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='img/val/mapillaryvistas/',
        ann_dir='ann/val/mapillaryvistas/',
        classes=['road', 'sidewalk', 'vegetation', 'terrain'],
        palette=[[128, 64, 128], [244, 35, 232], [107, 142, 35], [152, 251, 152]],
